...
func main() {
	...
	for { // бесконечный цикл чтения сообщений из стрима
		...
		// используем единый вывод с сервером, для этого конвертируем прото в снепшот и даём дефолтную конфигурацию что бы не тащить за собою конфиг
		// не по grpc и не файлом. в случае отключения функций на сервере -> в клиенте будут висеть нулевые значения в выключенных функциях.
