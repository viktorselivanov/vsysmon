...
func RingSnapshot() []model.Sample {
...
func SaveSnapshot(s model.Snapshot) { // Эта функция нужна для того, чтобы клиенты gRPC могли безопасно получить последний snapshot, не опасаясь гонок.
